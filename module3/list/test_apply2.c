...
void change_plate(car_t *cp) {
	strcpy(cp->plate, "Toyota Highlander");
}
...
int main() {
    ...
    if (strcmp(car_p->plate, "Toyota Highlander") == 0 && strcmp(car2_p->plate, "Toyota Highlander") == 0 && strcmp(car3_p->plate, "Toyota Highlander") == 0 && strcmp(car4_p->plate, "Toyota Highlander") == 0&& strcmp(car5_p->plate, "Toyota Highlander") == 0){
        exit(EXIT_SUCCESS);
    } else {
        exit(EXIT_FAILURE);
    }
