 ...
 * Version: 1.0
 * 
 * Description: Test for hsearch to find element in the hashtable
 * 
 */
...
int main() {
    ...
    student_t *resultp = (student_t*)hsearch(htp, (bool (*)(void *, const void *))compareStudent, "Emily Davis", 6);
    
    if (resultp == person3) { // Found the right student
        exit(EXIT_SUCCESS);
    } else {
        exit(EXIT_FAILURE);
    }
